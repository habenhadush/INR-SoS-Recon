...
class SirenMLP(nn.Module):
    ...
    def __init__(self, 
        ...
        # 1. First Layer
        self.net.append(_SineLayer(in_features, hidden_features, is_first=True, omega_0=omega_0))
        
        # 2. Hidden Layers
        for _ in range(hidden_layers):
            self.net.append(_SineLayer(hidden_features, hidden_features, is_first=False, omega_0=omega_0))
